<template>
  <div>
    <div
      class="avatar-upload w-full hover:bg-gray-2 rounded-lg duration-300 relative group !cursor-pointer overflow-hidden"
    >
      <input
        ref="fileInput"
        accept=".jpg, .jpeg, .png"
        class="absolute top-0 right-0 w-full left-0 bottom-0 z-20 opacity-0 cursor-pointer"
        type="file"
        @change="previewImage"
...
import UIStoryPoster from "@/components/Common/Avatar/UIStoryPoster.vue";
