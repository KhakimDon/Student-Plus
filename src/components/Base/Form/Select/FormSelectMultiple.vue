  ...
  <div ref="select" class="relative">
    ...
    <div
      :class="[
        ...
        { '!border-primary ': showOptions },
        headStyles,
      ]"
      class="transition-200 px-3 h-10 py-2.5 bg-gray-50 transition-all duration-300 border border-transparent cursor-pointer flex items-center justify-between rounded-lg w-full"
      tabindex="1"
    ...
    <Transition name="fade">
      <ul
        ...
        class="absolute w-full bg-white pl-3 divide-gray/40 divide-y shadow-custom_select z-10 translate-y-3 overflow-hidden max-h-[334px] overflow-y-scroll text-white rounded-md shadow-custom"
      >
        ...
        <slot v-else name="options">
          <li
            ...
            :key="idx"
            class="transition-300 cursor-pointer hover:bg-gray-6"
